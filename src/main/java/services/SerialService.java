...
public class SerialService {
    ...
    private final List<SerialHandler<String>> handlers = new ArrayList<>();
     ...
     * @param handler
     */
    public void addHandler(SerialHandler<String> handler) {
     ...
     * @param handler
     */
    public void removeHandler(SerialHandler<String> handler) {
    ...
    public void broadcast(String data) {
        for (SerialHandler<String> handler : handlers) {
