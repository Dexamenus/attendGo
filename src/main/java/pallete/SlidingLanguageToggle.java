...
import services.I18nService; // Wajib di-import agar terhubung dengan sistem bahasa
...
public class SlidingLanguageToggle extends JToggleButton {
    ...
    // Indeks Bahasa: 0 = Indonesia, 1 = Inggris, 2 = Mesir
    private int selectedLanguageIndex = 0; 
    
    // Label teks statis (Bisa juga disesuaikan jika ingin dinamis)
    private final String[] languages = {"Indonesia", "Inggris", "Mesir"};
    private final String[] langcodes = {"id", "en", "ar_EG"};
    ...
    public SlidingLanguageToggle() {
        ...
        addMouseListener(new MouseAdapter() {
            ...
            public void mousePressed(MouseEvent e) {
                ...
                // 1. Tentukan indeks berdasarkan koordinat klik X
                ...
                // 2. Ambil kode bahasa yang baru saja dipilih ("id", "en", atau "ar_EG")
                String selectedLangCode = langcodes[getSelectedLanguageIndex()];
                
                // 3. Simpan ke database lokal (Preferences)
                setting.prefs.put("LANGUAGE", selectedLangCode);
                
                // 4. PICU PERUBAHAN GLOBAL! 
                // Ini akan menyuruh I18nService untuk menyebarkan sinyal ke PageAdmin dan form Setting
                // agar teks mereka langsung berubah saat itu juga.
                I18nService.setLocale(new Locale(selectedLangCode));
            }
        });
    }
    ...
    public void setSelectedLanguageIndexByString(String lang) {
        switch (lang) {
            ...
            case "ar_EG":
                ...
                break;
            default:
                this.selectedLanguageIndex = 0; // Default kembali ke Indonesia jika error
                break;
        }
        repaint(); // Pastikan digambar ulang setelah diset
    }
