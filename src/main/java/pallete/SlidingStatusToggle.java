...
public class SlidingStatusToggle extends JToggleButton {
    ...
    public void setStatusByString(String status) {
        if (I18nService.get("ui.button.keluar").equalsIgnoreCase(status)) {
    ...
    public String getStatusString() {
        return isSelected() ? I18nService.get("ui.button.keluar") : I18nService.get("ui.button.masuk");  
    }
    ...
    protected void paintComponent(Graphics g) {
        ...
        String textLeft = I18nService.get("ui.button.masuk");
        ...
        String textRight = I18nService.get("ui.button.keluar");
